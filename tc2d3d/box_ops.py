...
def bbox_to_box3d(bboxes, dims, yaw, cam2img, origin=0.5):
    ...
    for idxs in combinations:
        A = M[:, idxs,
              [0, 1, 0, 1], :3] - M[:, idxs, 2, :3] * bboxes[:, :, None]
...
combinations = ((4, 0, 1, 6), (4, 0, 2, 6), (7, 0, 1, 6), (7, 0, 2, 6),
                (0, 1, 5, 7), (0, 1, 6, 7), (3, 1, 5, 7), (3, 1, 6, 7),
                (5, 4, 0, 2), (5, 4, 3, 2), (6, 4, 0, 2), (6, 4, 3, 2),
                (1, 5, 4, 3), (1, 5, 7, 3), (2, 5, 4, 3), (2, 5, 7, 3),
                (1, 0, 4, 3), (1, 0, 7, 3), (2, 0, 4, 3), (2, 0, 7, 3),
                (5, 1, 0, 2), (5, 1, 3, 2), (6, 1, 0, 2), (6, 1, 3, 2),
                (0, 4, 5, 7), (0, 4, 6, 7), (3, 4, 5, 7), (3, 4, 6, 7),
                (4, 5, 1, 6), (4, 5, 2, 6), (7, 5, 1, 6), (7, 5, 2, 6),
